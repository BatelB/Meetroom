...
public class EditRoom  extends AppCompatActivity {
    ...
    void editRoom(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Global.base_URL + "/php/edit_room.php",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(response.equals("success")){
                            Toast.makeText(EditRoom.this, "Room#", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(EditRoom.this, "Error, could not create room", Toast.LENGTH_SHORT).show();
                        }
